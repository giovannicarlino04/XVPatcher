...
void CpkFile::UnlinkFileFromDirectory(int file_index)
{
	uint8_t *toc_table = toc.GetPtrTable();	
	*(uint32_t *)(toc_table + files_table[file_index].dir_name_pos) = 0; // will point the dir name to go to "<NULL>" string
